      ...
      <div className="bg-white/95 rounded-3xl shadow-lg max-w-5xl w-full px-8 py-12 mx-4 border border-neutral-200">
        ...
        <div className="prose prose-lg max-w-none text-gray-800 mx-auto">
          <p>
            ...
            your personal information when you use our website (thellmstxt.com)
            and related services. By using our site, you agree to the practices
          ...
          <ul>
            <li>
              ...
              visits such as pages viewed and resources accessed (traffic data,
          ...
          <p>
            ...
            details (such as your credit card or bank account information) while
            processing payments. All payment-related functions are handled
          ...
          <p>
            We use cookies to gather information about your computer to help us
            improve our website. Cookies may collect statistical data about your
            browsing actions and patterns, but do not identify you personally.
            You can adjust your browser settings to decline cookies if you wish.
          </p>
          <p>
            Our advertisers or analytics partners may also use cookies, over
            which we have no control. Such cookies would be downloaded once you
            click on advertisements or interact with third-party content on our
            website.
          </p>
          {/* <hr className="my-8 border-neutral-200" /> */}
          ...
          <p>
            Your data may be transferred to and stored in locations outside your
            country (including outside the United States) for processing. By
            providing your personal data, you agree to this transfer, storing,
            or processing. We take reasonable steps to ensure your data is
            treated securely.
          </p>
          {/* <hr className="my-8 border-neutral-200" /> */}
          ...
          <p>
            ...
            and such information can occasionally be intercepted. Sending
          ...
          <ul>
            <li>
              We will not disclose your personal information except as described
              in this policy.
            </li>
            <li>
          ...
          <p>
            ...
            with business partners, trusted affiliates, and advertisers for the
          ...
          <p>
            ...
            information. Your continued use of the site after changes are posted
          ...
          <p>
            Accounts on this site can be anonymized or deleted at your request.
            Contact us at{" "}
          ...
          <p>
            ...
            us at <a href="mailto:hello@thellmstxt.com">hello@thellmstxt.com</a>
            .
          </p>
        </div>
      </div>
