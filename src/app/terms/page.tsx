      ...
      <main className="bg-neutral-50 min-h-screen py-12 flex items-center justify-center">
        <div className="bg-white/95 rounded-3xl shadow-lg max-w-5xl w-full px-8 py-12 mx-4 border border-neutral-200">
          ...
          <div className="prose prose-lg max-w-none text-gray-800 mx-auto">
            <p>
              This website is operated by TheLLMsTxt.com. Throughout the site,
              the terms &quot;we&quot;, &quot;us&quot; and &quot;our&quot; refer
              to TheLLMsTxt.com. TheLLMsTxt.com offers this website, including
            ...
            <p>
              By visiting our site and/or using our free or paid services, you
              ...
              including without limitation users who are browsers, customers,
            ...
            <p>
              ...
              at least the age of majority in your jurisdiction, or that you are
              the age of majority and you have given us your consent to allow
            ...
            <p>
              ...
              transfer over networks by the gateway providers.
            </p>
            <p>
            ...
            <p>
              ...
              product or service at any time. Any offer for any product or
            ...
            <p>
              We reserve the right to refuse any order or membership payment you
              place with us. We may, in our sole discretion, limit or cancel the
              services and features you paid with us. These restrictions may
              include membership or subscription fee paid by or under the same
              ...
              change to or cancel a membership, we may attempt to notify you by
              contacting the e-mail and/or billing address/phone number provided
              at the time of registration or at the time payment was made. We
              reserve the right to limit or prohibit membership that, in our
              sole judgment, appear to be placed by dealers, resellers or
              distributors.
            </p>
            <p>
              You agree to provide current, complete and accurate purchase and
              account information for all payment made at our site. You agree to
              promptly update your account and other information, including your
              email address and credit card numbers and expiration dates (with
              the payment gateway), so that we can complete your transactions
            ...
            <p>
              ...
              omissions that may relate to service or plan descriptions,
              pricing, promotions, offers, additional charges, working hours and
            ...
            <p>
              Unfortunately we can&apos;t offer you a refund for the payment
              made if you choose to cancel your membership, midway through the
              plan duration, after paying for any of our plan. But, we do
              provide refund under rare circumstances. In case, if we choose to
              cancel your membership from our platform, we would provide you the
              refund amount eligible for the remaining months in your membership
              duration (the month of cancellation of membership would not be
            ...
            <p>
              ...
              expressly stated by us) provided &apos;as is&apos; and & your use,
            ...
            <p>
              In no case shall TheLLMsTxt.com, our directors, officers,
            ...
            <p>
              You agree to indemnify, defend and hold harmless TheLLMsTxt.com
            ...
            <p>
              ...
              accordance with the laws of India and you hereby submit to the
            ...
            <p>
              ...
              contact us by dropping an email at{" "}
              <a
                href="mailto:support@thellmstxt.com"
                className="text-blue-600 underline"
              >
                support@thellmstxt.com
              </a>
            </p>
          </div>
        </div>
