      ...
      <div className="bg-white/95 rounded-2xl sm:rounded-3xl shadow-lg max-w-5xl w-full px-4 sm:px-8 py-8 sm:py-12 mx-2 sm:mx-4 border border-neutral-200">
        ...
        <div className="prose prose-base sm:prose-lg max-w-none text-gray-800 mx-auto">
          <p>
            ...
            TheLLMsTxt.com. TheLLMsTxt.com offers this website, including all
          ...
          <p>
            ...
            limitation users who are browsers, customers, and/or contributors of
            content.
          </p>
          <p>
          ...
          <p>
            ...
            least the age of majority in your jurisdiction, or that you are the
            age of majority and you have given us your consent to allow any of
          ...
          <p>
            ...
            networks by the gateway providers.
          </p>
          <p>
          ...
          <p>
            ...
            reserve the right to limit or prohibit membership that, in our sole
          ...
          <p>
            ...
            email address and credit card numbers and expiration dates (with the
            payment gateway), so that we can complete your transactions and
          ...
          <p>
            ...
            may relate to service or plan descriptions, pricing, promotions,
            offers, additional charges, working hours and availability. We
          ...
          <p>
            Unfortunately we can&apos;t offer you a refund for the payment made
            if you choose to cancel your membership, midway through the plan
            duration, after paying for any of our plan. But, we do provide
            refund under rare circumstances. In case, if we choose to cancel
            your membership from our platform, we would provide you the refund
            amount eligible for the remaining months in your membership duration
            (the month of cancellation of membership would not be included). We
          ...
          <p>
            In no case shall TheLLMsTxt.com, our directors, officers, employees,
          ...
          <p>
            You agree to indemnify, defend and hold harmless TheLLMsTxt.com and
