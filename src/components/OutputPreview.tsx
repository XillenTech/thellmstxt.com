...
const OutputPreview = ({ content }: OutputPreviewProps) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 sticky top-24">
      ...
      <div className="bg-gray-900 rounded-lg p-4 font-mono text-sm overflow-x-auto mb-4 max-h-64">
      ...
      <div className="mt-4 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg">
        <p className="text-sm text-gray-700 mb-2">
          <strong>Next step:</strong> Upload this file to your website&apos;s root directory
        </p>
        <code className="text-xs bg-white px-2 py-1 rounded text-blue-600">
