        ...
        <div className="text-center">
          <div className="flex justify-center mb-6">
            <div className="flex items-center space-x-2 bg-blue-100 px-4 py-2 rounded-full">
              ...
              <span className="text-sm font-medium text-blue-800">Free Tool</span>
            </div>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-4xl mx-auto leading-relaxed">
            Instantly generate the rules to guide AI crawlers. Take control of how models like 
            <span className="font-semibold text-blue-600"> ChatGPT</span> and 
            <span className="font-semibold text-purple-600"> Gemini</span> see your website. 
            Free and simple.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            >
              <span>Create Your llms.txt Now</span>
              <ArrowDown className="h-5 w-5 group-hover:translate-y-1 transition-transform" />
            </button>
            <p className="text-sm text-gray-500">No signup required • Instant download</p>
          </div>
        </div>
          ...
          <div className="relative">
            <div className="bg-white rounded-xl shadow-2xl p-6 max-w-md">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className="text-sm text-gray-500 ml-2">yoursite.com/llms.txt</span>
              </div>
              <div className="bg-gray-50 rounded-lg p-4 font-mono text-sm">
                <div className="text-green-600"># llms.txt</div>
