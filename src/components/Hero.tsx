        ...
        <div className="text-center">
          <div className="flex justify-center mb-4 sm:mb-6">
            <div className="flex items-center space-x-2 bg-blue-100 px-3 sm:px-4 py-2 rounded-full">
              ...
              <span className="text-xs sm:text-sm font-medium text-blue-800">Free llms.txt Generator Tool</span>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4">
            ...
            <p className="text-xs sm:text-sm text-gray-500 text-center">Compare llms.txt tools vs plugins • Instant download</p>
          </div>
        </div>
          ...
          <div className="relative w-full max-w-md">
            <div className="bg-white rounded-xl shadow-2xl p-4 sm:p-6">
              <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
                ...
                <span className="text-xs sm:text-sm text-gray-500 ml-2">llms.txt format spec example</span>
              </div>
